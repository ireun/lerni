...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/static/styles/refineslide.css" />
    <!-- Fav and touch icons -->
  ...
  <div id="wrapper">
    ...
    <!-- Header -->
               <!--
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Szkoła <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Informacje Podstawowe</a></li>
                  <li><a href="#">Patron</a></li>
                  <li><a href="#">Historia szkoły</a></li>
                  <li><a href="#">Regulamin szkoły</a></li>
                </ul>
              </li>
              --->