...
<section id="main">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <header><h4 class="title">Otwarte klasy</h4>
                <ul class="toolbar pull-right">
                    <li><a href="#" class="link"><span class="icon icon-plus"></span></a></li>
                    <li class="">
                        <a href="#" class="link" data-toggle="dropdown"><span class="icon icon-filter"></span></a>
                        <ul class="dropdown-menu">
                            <li class="filter" data-filter="all" class="active"><a href="#">Wszystko</a></li>
                            %for row in categories:
                            <li class="filter" data-filter="${row[1]}"><a href="#">${row[0]}</a></li>
                            %endfor
                        </ul>
                    </li>
                </ul>
            ...
            <section class="body">
                ...
                <ul id="Grid">
                    %for row in groups:
                    <li class="list-group-item mix ${row[0]} ${row[1]}"><a href="#">${row[2]}</a><span class="badge">0</span></li>
                    %endfor
                </ul>
                </div>
            </section>
            </div>
            <div class="span8 widget dark">
                <header><h4 class="title">Uczniowie</h4>
                <ul class="toolbar pull-right">
                    <li><a href="#" class="link"><span class="icon icon-rotate-270 icon-reply"></span></a></li>
                </ul>
                </header>
                <section class="body">
                    <div class="body-inner">
                        <div class="row-fluid">
                            <div class="span8">
                            <input class="typeahead" type="text" placeholder="Adres email ucznia którego chcesz dodać.">
                            </div>
                            <button type="button" class="btn btn-success span4"><span class="icon-add"></span>Dodaj</button>
                        </div>
	<table>
		<thead>
			<tr>
