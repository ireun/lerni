...
class People(Base):
	...
	def __init__(self,first_name,second_name,last_name,pesel,birthdate,phonenumber,email,password,key_data,fingerprint,wallet_id,email_confirmed,gpg_confirmed,phone_confirmed,group_id):
	...
	def check_password(self, password):
		return self.password == hashlib.sha512(unicode(password+str(self.registration_date)).encode('utf-8')).hexdigest()
	def __repr__(self):
