...
class Absent(Base):
    ...
    def __init__(self, teacher_id, reason, lesson1, lesson2, lesson3, lesson4, lesson5, lesson6, lesson7, lesson8,
                 substitutions_id):
...
class Replace(Base):
    ...
    def __init__(self, teacher_id, empty_column, c1_id, c1_g1, c1_g2,
                 c2_id, c2_g1, c2_g2, c3_id, c3_g1, c3_g2, c4_id, c4_g1, c4_g2,
                 c5_id, c5_g1, c5_g2, c6_id, c6_g1, c6_g2, c7_id, c7_g1, c7_g2, c8_id,
                 c8_g1, c8_g2, substitutions_id):
        self.teacher_id = teacher_id
...
class Association(Base):
    ...
    groups_id = Column(Integer, ForeignKey('log_groups.id'))
    ## possibly nosense
