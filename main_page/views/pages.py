...
def competitions(request):
    #WTF is that O_O
    username = request.params['username'] + request.params['n1a'] + request.params['n2a'] + request.params['n3a'] +\
               request.params['n4a'] + request.params['n1b'] + request.params['n2b'] + request.params['n3b'] +\
               request.params['n4b'] + request.params['n1c'] + request.params['n2c'] + request.params['n3c'] +\
               request.params['n4c'] + request.params['n1d'] + request.params['n2d'] + request.params['n3d'] +\
               request.params['n4d'] + request.params['n1e'] + request.params['n2e'] + request.params['n3e'] +\
               request.params['n4e'] + request.params['n1f'] + request.params['n2f'] + request.params['n3f']\
               + request.params['n4f']
    print(username)
